...
authors = ["A.T.Y. Ho", "K.P. Huynh", "D.T. Jacho-Chavez", "K. Leinenbach", "C.H. Rea"]
publication_types = ["6"]
publication = "In **Teaching Econometrics: A Tribute to R. Carter Hill**, *Advanced Studies in Theoretical and Applied Econometrics* (56), pp. 115-132, edited by Eric Hillebrand and William Griffiths. Springer Nature."
publication_short = "In **Teaching Econometrics: A Tribute to R. Carter Hill**, Springer Nature."
...
abstract_short = "This research discusses how reproducibility and replicability can be taught to economists and social scientists while learning econometrics by leveraging self-contained, cloud-based computing environments and open-source software."
image_preview = ""
selected = true
projects = []
tags = []
