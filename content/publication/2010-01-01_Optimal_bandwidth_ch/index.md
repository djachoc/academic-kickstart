...
abstract = "This paper characterizes the bandwidth value $h$ that is optimal for estimating parameters of the form, where the conditional density of a scalar continuous random variable $V$, given a random vector $U$, $f_{V|U}$. The expansion also demonstrates that the bandwidth can be chosen on the basis of bias alone, and that a simple 'plug-in' estimator for the optimal bandwidth can be constructed. Finally, the small sample performance of our proposed estimator of the optimal bandwidth is assessed by a Monte Carlo experiment. © Cambridge University Press, 2009."
abstract_short = ""
image_preview = ""
selected = false
projects = []
